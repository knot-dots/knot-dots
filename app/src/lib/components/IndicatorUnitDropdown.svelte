<script lang="ts">
  ...
  import { units as unitEnum, type IndicatorContainer, type IndicatorTemplateContainer, type AnyContainer } from '$lib/models';
...
<style>
  .readonly { display:inline-block; min-width:2rem; }
</style>
