...
<header>
	...
	{#if editable}
		<ul class="inline-actions is-visible-on-hover">
			{#if $mayCreateContainer(payloadTypes.enum.resource, container.managed_by) && templateAvailability.has(payloadTypes.enum.resource)}
				<li>
					<button
...
<Carousel
	{addItem}
	{items}
	mayAddItem={$mayCreateContainer(payloadTypes.enum.resource, container.managed_by) &&
		editable &&
