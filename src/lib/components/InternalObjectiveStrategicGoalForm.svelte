<script lang="ts">
	...
	import type { Container, EmptyInternalObjectiveStrategicGoalContainer, InternalObjectiveStrategicGoalContainer } from '$lib/models';
	import { Editor } from 'bytemd';
	import RelationSelector from './RelationSelector.svelte';

	export let container: InternalObjectiveStrategicGoalContainer | EmptyInternalObjectiveStrategicGoalContainer;
