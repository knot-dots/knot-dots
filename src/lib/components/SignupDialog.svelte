...
<Dialog bind:dialog>
	<form class="details" on:submit|preventDefault={handleSubmit}>
		...
		<label>
			...
			<input type="text" name="givenName" autocomplete="given-name" bind:value={givenName} required/>
		</label>
		<label>
			{$_('signup_dialog.family_name')}
			<input type="text" name="familyName" autocomplete="family-name" bind:value={familyName} required/>
		</label>
		<label>
			{$_('signup_dialog.password')}
			<input type="password" name="password" autocomplete="new-password" bind:this={passwordInput} bind:value={password} required/>
		</label>
		<label>
			{$_('signup_dialog.password_confirm')}
			<input type="password" name="passwordConfirm" autocomplete="new-password" bind:this={passwordConfirmInput} bind:value={passwordConfirm} required/>
		</label>
