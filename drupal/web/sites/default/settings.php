 ...
 * its location.
 */
$settings['config_sync_directory'] = '/srv/app/config';
 ...
 * Global overrides
 *
 * The configuration system integrates these override values via the
 * Drupal\Core\Config\ConfigFactory::get() implementation. When you retrieve a
 * value from configuration, the global $config variable gets a chance to
 * change the returned value.
 */
$config['locale.settings']['translation']['path'] = 'profiles/custom/knotdots/translations';
$config['s3fs.settings']['bucket'] = getenv('S3FS_BUCKET');
$config['symfony_mailer_lite.symfony_mailer_lite_transport.smtp']['configuration']['user'] = getenv('SMTP_USERNAME');
$config['symfony_mailer_lite.symfony_mailer_lite_transport.smtp']['configuration']['pass'] = getenv('SMTP_PASSWORD');
$config['symfony_mailer_lite.symfony_mailer_lite_transport.smtp']['configuration']['host'] = getenv('SMTP_HOST');
$config['symfony_mailer_lite.symfony_mailer_lite_transport.smtp']['configuration']['port'] = getenv('SMTP_PORT');
$config['symfony_mailer_lite.symfony_mailer_lite_transport.smtp']['configuration']['query']['verify_peer'] = (bool) getenv('SMTP_TLS_PEER_VERIFICATION');

$settings['php_storage']['twig']['directory'] = '/srv/app/twig';
$settings['s3fs.access_key'] = getenv('S3FS_ACCESS_KEY');
$settings['s3fs.secret_key'] = getenv('S3FS_SECRET_KEY');
$settings['s3fs.use_s3_for_public'] = (bool) getenv('S3FS_USE_S3_FOR_PUBLIC');
