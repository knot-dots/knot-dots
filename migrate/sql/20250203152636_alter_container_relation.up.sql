...
INSERT INTO container_relation (object, object_revision, predicate, subject, subject_revision, valid_currently, valid_from)
SELECT o.guid AS object, o.revision, cr.predicate, s.guid AS subject, s.revision, false, s.valid_from
...
ON CONFLICT ON CONSTRAINT container_relation_object_rev_predicate_subject_rev_key DO UPDATE
    SET object = excluded.object, subject = excluded.subject, valid_currently = false, valid_from = excluded.valid_from;
...
INSERT INTO container_relation (deleted, object, object_revision, predicate, subject, subject_revision, valid_currently, valid_from)
SELECT final.* FROM (
